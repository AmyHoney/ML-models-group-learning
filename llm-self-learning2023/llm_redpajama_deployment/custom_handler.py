...
class TransformersSeqClassifierHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx):
        ...
        print(f"==============Load model to cuda: {self.device}")
        self.model.to(self.device)
        
        print(f"==============Start to load tokenizer============")
        # Setting pad_token, when pad_token_id is None
        self.tokenizer = AutoTokenizer.from_pretrained(
            model_dir + "/model", pad_token="<|endoftext|>", return_tensors="pt"
        )

        # Setting pad_token, when pad_token_id is None
        print(f"=====add pad_token=========self.tokenizer: {self.tokenizer}")
        self.tokenizer.pad_token_id = self.tokenizer.eos_token_id
        print(f"=====tokenizer pad_token_id=========self.tokenizer.pad_token_id: {self.tokenizer.pad_token_id}")
